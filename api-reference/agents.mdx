...
response = requests.post(
    f"https://api.thunderphone.ai/v1/orgs/{org_id}/agents",
    headers={
...
<CodeGroup>
```bash cURL
curl -X PATCH https://api.thunderphone.ai/v1/orgs/{org_id}/agents/12 \
  -H "Authorization: Token YOUR_API_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
response = requests.patch(
    f"https://api.thunderphone.ai/v1/orgs/{org_id}/agents/12",
    headers={
        "Authorization": "Token YOUR_API_TOKEN",
        "Content-Type": "application/json"
    },
...
```bash
curl -X POST https://api.thunderphone.ai/v1/orgs/{org_id}/agents/12/duplicate \
  -H "Authorization: Token YOUR_API_TOKEN"
```
...
```bash
curl -X DELETE https://api.thunderphone.ai/v1/orgs/{org_id}/agents/12 \
  -H "Authorization: Token YOUR_API_TOKEN"
```
