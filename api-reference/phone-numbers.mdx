...
response = requests.get(
    f"https://api.thunderphone.com/v1/orgs/{org_id}/phone-numbers",
...
const response = await fetch(
  `https://api.thunderphone.com/v1/orgs/${orgId}/phone-numbers`,
  {
    headers: { 'Authorization': 'Token YOUR_API_TOKEN' }
  }
);
...
response = requests.patch(
    f"https://api.thunderphone.com/v1/orgs/{org_id}/phone-numbers/101",
    headers={
        "Authorization": "Token YOUR_API_TOKEN",
        "Content-Type": "application/json"
    },
